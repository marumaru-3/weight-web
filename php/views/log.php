  ...
  <div class="weight-graph card">
    ...
    <ul class="weight-graph__switch">
      <li class="weight-graph__item">
        <button id="weight-graph__week" class="btn">1週間</button>
      </li>
      <li class="weight-graph__item">
        <button id="weight-graph__month" class="btn btn--select">1ヶ月</button>
      </li>
      <li class="weight-graph__item">
        <button id="weight-graph__three-month" class="btn">3ヶ月</button>
      </li>
      <li class="weight-graph__item">
        <button id="weight-graph__half-year" class="btn">半年</button>
      </li>
      <li class="weight-graph__item">
        <button id="weight-graph__year" class="btn">1年</button>
      </li>
    </ul>
